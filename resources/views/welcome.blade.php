            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <div class="right-phone-box">
                        <p>| Téléphone : <a href="#"> 900 800 100</a></p>
                    </div>
                    <div class="our-link">
                        <ul>
                            <li><a href="http://localhost/blog/public/login">Espace Entreprise</a></li>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        ...
                        <li class="nav-item"><a class="nav-link" href="presentation.php">Présentation</a></li>
                        <li class="dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Secteur d'activités</a>
                                <ul class="dropdown-menu">
                                
                                </ul>                          
                        </li>
                        <li class="dropdown">
                            <a href="abonnement.php" class="nav-link dropdown-toggle" data-toggle="dropdown">Abonnement</a>
                        </li>
